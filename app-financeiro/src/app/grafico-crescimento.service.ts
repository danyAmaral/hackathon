...
export class GraficoCrescimentoService {
    public getInvestimentoPorArea(): AreaChartValues[] {
        let investimentoAreasData: AreaChartValues[] = [
            { ano: 2019, mes: 1, periodo: '01/2019', operacional: 1, comercial: 90000, financeiro: 50000, infraestrutura: 85000 },
            { ano: 2020, mes: 1, periodo: '01/2020', operacional: 100000, comercial: 90000, financeiro: 50000, infraestrutura: 85000 },
